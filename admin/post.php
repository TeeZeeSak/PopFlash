...
<head>
	...
	<?php
		$posting_mode = $request->variable("action", "", true);
		if($posting_mode == "new"){
			echo '<title>PopFrag.eu - Nový příspěvek</title>';
		}else if($posting_mode == "edit"){
			echo '<title>PopFrag.eu - Upravit příspěvek</title>';
		}
	?>
